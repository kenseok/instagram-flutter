...
import 'package:instagram_kenseok_app/widgets/profile_side_menu.dart';
  ...
  Row get _getProfileHeader => Row(
        children: <Widget>[
          Padding(
            ...
            child: CircleAvatar(
              radius: 40,
              backgroundImage: NetworkImage(getProfileImgPath('The kenseok')),
            ),
          ),
          Expanded(
            child: Table(
