...
import 'package:instagram_kenseok_app/constants/firebase_keys.dart';
...
import 'package:instagram_kenseok_app/firebase/transformer.dart';
...
//Post
  ...
  Stream<List<Post>> fetchAllPostFromFollowers(List<dynamic> followings) {
    ...
    return CombineLatestStream (streams, (listOfPosts) {
